...
url_app_pattern = [
    ...
    path('post/<slug:post_slug>/update/', ChangePostView.as_view(), name='update_post_url'),
    ...
    path('post/<slug:post_slug>/delete/<int:comment_id>/', DeleteComment, name='delete_comment_url'),
